...
![The Archive Dashboard](src/assets/dashboard.png)
*Personal dashboard for uploading, managing, and summarizing documents.*

![Document Upload](src/assets/upload.png)
*Document upload interface.*

![Document Chat](src/assets/SummaryRagChat.png)
*Interactive chat session focusing on a specific document using RAG.*

![Agent Chat](src/assets/AgentChat.png)
...
![Technologies](https://skillicons.dev/icons?i=typescript,react,tailwindcss,vite,git)
...
<a href="https://github.com/Rbt-Ghost">
    <img src="https://github.com/Rbt-Ghost.png" width="64px" alt="Robert Profile" />
</a>

<a href="https://github.com/BCBeno">
    <img src="https://github.com/BCBeno.png" width="64px" alt="Beno Profile" />
</a>
